...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس ', url = "https://t.me/Escobar_source"}
},
}
local msgg = msg_id/2097152/0.5
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/joook66/29&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
