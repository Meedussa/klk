...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Cocaine_source'}, },}}
...
--download('https://raw.githubusercontent.com/Meedussa/klk/COCAINE.lua','COCAINE.lua')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ تـــم تحديث السورس * ',"md",true)
end
...
NamesBot = (Redis:get(COCAINE.."COCAINE:Name:Bot") or "كوكاين")
Groups = (Redis:scard(COCAINE..'COCAINE:ChekBotAdd') or 0)
Users = (Redis:scard(COCAINE..'COCAINE:Num:User:Pv') or 0)
if photo.total_count > 0 then
local Jabwa = 'اسـࢬ الـبـﯡت ↢ '..NamesBot..''
local Grosupsw = 'الجـࢪﯡبـات ↢ '..Groups..''
local Usperos = 'الࢬـشترڪـيڼ ↢ '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = Jabwa, url = 't.me/Cocaine_source'}, 
},
{
{text = Grosupsw, url = 't.me/Cocaine_source'}, 
},
{
{text = Usperos, url = 't.me/Cocaine_source'}, 
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ اسم المجموعه -❈『*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*』\n 📮│تـم تـفـعـيـل آلمـجمـوعهہ‌‏ *','md', true, false, false, false, reply_markup)
end
end 
...
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local news = '🧪🌚 ڕٺــبــٿــڪ ڣــۑْۧ ּا̍ڵــبــﯜٺ ↢ '..msg.Name_Controller
if photo.total_count > 0 then
data = {} 
...
if TextMsg == 'قولي' then
Redis:set(COCAINE.."Status:kool"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ تم تفعيل امر قولي ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ تم تعطيل امر قولي ","md",true)
end
if TextMsg == 'جمالي' then
...
return LuaTele.sendText(msg_chat_id,msg_id,'*⦁ اتاكــد قبل ما تـطلعننـي 😿👇🏻*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"📡╽تــ✓ــم فتح التكرار").unLock,"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 🍷╽الصور بالتأكيد تــ✓ــم فتحها").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"📡╽تــ✓ــم فتح الفيديو").unLock,"md",true)  
return false
end 
...
data = {
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬  . ❈', url = 't.me/Cocaine_source'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس ', url = "https://t.me/Cocaine_source"}
},
}
local msgg = msg_id/2097152/0.5
...
local T =[[
⦑ W𝙀𝙇𝘾𝙊𝙈𝙀 T𝙊 C𝙊𝘾𝘼𝙄𝙉𝙀 S𝙊𝙐𝙍𝘾𝙀🧪 ⦒
★┉ ┉ ┉ ┉ ┉ 𝙲𝙾𝙲𝙰 ┉  ┉ ┉ ┉ ┉★
➥┇W𝙴𝙻𝙲𝙾𝙼𝙴 T𝙾 C𝙾𝙲𝙰𝙸𝙽𝙴 S𝙾𝚄𝚁𝙲𝙴
...
keyboard.inline_keyboard = {
{
{text = '˹  𝑱𝑶𝑲 ⁦. 𓌗', url = "https://t.me/JOKN1"},{text = '˹  𝐵𝐴𝑁𝐷𝐴 ⁦. ❈', url = "https://t.me/Q_o_ll"}
},
{
{text = '˹  𝑴𝑬𝑫𝑼𝑺𝑨 ⁦. 𓌗', url = "https://t.me/Medusavip21"},{text = '˹  𝑻𝑾𝑺𝑶 ⁦. ❈', url = "https://t.me/Cocaine_source"}
},
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬 . ❈', url = "https://t.me/Cocaine_source"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/joook66/38&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '❈ اوامر التفعيل والتعطيل ❈', data = msg.sender.user_id..'/listallAddorrem'}, {text = '❈ اوامر الفتح والقفل ❈', data = msg.sender.user_id..'/NoNextSeting'}, 
},
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬  . ❈', url = 't.me/Cocaine_source'}, 
},
...
╣•𝟑• ❈ اوامر الاعضاء ❈
╣•𝟒• ❈ اوامر المسح ❈
╣•𝟓• ❈ اوامر التفعيل والتعطيل ❈
╝•𝟔• ❈ اوامر الفتح والقفل ❈
...
return LuaTele.sendText(msg_chat_id,msg_id,'❈ اليك قسم الالعاب من سورس كوكاين ❈',"md",false, false, false, false, reply_markup)
end
if text == 'جوك' or text == 'jok' or text == 'JOK' then
photo = "https://t.me/JOKN1"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙹𝙾𝙺 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '.َ ‹𝙹𝙾𝙺‏𝙓⃟🇨🇭', url = "https://t.me/JOKN1"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ميدوسا' or text == 'medusa' or text == 'Medusa' then
photo = "https://t.me/medusavip21"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝑴𝒆𝒅𝒖𝒔𝒂 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '.َ ‹𝑴𝒆𝒅𝒖𝒔𝒂𝙓⃟🇨🇭', url = "https://t.me/medusavip21"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'كوكاين' or text == 'كوكين' then
if not Redis:get(COCAINE.."COCAINE:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* 🌚*","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عاوز ايه من السورس 🙂*',"md",false, false, false, false, reply_markup)
end
...
local NamesBot = (Redis:get(COCAINE.."COCAINE:Name:Bot") or "كوكاين")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/Cocaine_source'}, 
},
{
...
if text == (Redis:get(COCAINE.."COCAINE:Name:Bot") or "كوكاين") then
local photo = LuaTele.getUserProfilePhotos(COCAINE)
local ban = LuaTele.getUser(COCAINE)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
if text == "اطلعي" or text == "بوت غادر" or text == "غادر" then 
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ هاذا الامر يخص 『 '..Controller_Num(3)..' 』* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(COCAINE.."COCAINE:LeftBot") then
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس كوكاين؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس كوكاين؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(COCAINE.."COCAINE:Name:Bot") or "كوكاين")..
...
local TextHelp = [[*
 اهلا بك ف قسم اوامر اصحاب الرتـب
*]]
...
{
{text = '❈𝟓❈', data = IdUser..'/listallAddorrem'}, {text = '❈𝟔❈', data = IdUser..'/NoNextSeting'}, 
},
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬  . ❈', url = 't.me/Cocaine_source'}, 
},
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"*📡╽تــ✓ــم فتح الفيديو *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 🍷╽الصور بالتأكيد تــ✓ــم فتحها *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"*📡╽تــ✓ــم فتح التكرار *").unLock, 'md', true, false, reply_markup)
end
end
