...
data = {
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬  . ❈', url = 't.me/Escobar_source'}, 
},
}
}
...
local T = '* ❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓𝒔 𝑩𝒐𝒕 ❳\n— — — — — — — — —\n❈ : 𝑫𝒆𝒗 𝑵𝒂𝒎𝒆 : *'..ban.first_name..'*\n*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬 . ❈', url = "https://t.me/Escobar_source"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ مطور البوت : {*['..ban.first_name..'*}*',"md",true)  
end
end
end
...
{
{text = '˹  𝑴𝑬𝑫𝑼𝑺𝑨 ⁦. 𓌗', url = "https://t.me/Medusavip21"},{text = '˹  𝑻𝑾𝑺𝑶 ⁦. ❈', url = "https://t.me/Escobar_source"}
},
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬 . ❈', url = "https://t.me/Escobar_source"}
},
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/joook66/23&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
